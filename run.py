...
import sys
import webbrowser
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "book_collects.settings")

#these pertain to your application
import book_collects.wsgi
import book_collects.urls
import book_collects.settings
import book_collects.models
import book_collects.views
